...
class ForecastOpenCollective:
    ...
    def __get_open_collective_data(period_range: tuple[datetime]) -> dict:
        ...
        varibles = {"dateFrom": dateFrom, "dateTo": dateTo}
    ...
    def forecast(self) -> dict[str:datetime]:
        ...
        return {
            "forecast_no_income": self.__forecast_negative_cash_date(
                balance, cash_flow["outgoing"]
            ).strftime("%B %Y"),
            "forecast_continued_income": self.__forecast_negative_cash_date(
