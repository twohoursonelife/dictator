...
MOD_LOG_CHANNEL_ID = int(os.environ.get("MOD_LOG_CHANNEL_ID", 607929812119453697))
...
GENERAL_CHANNEL_ID = int(os.environ.get("GENERAL_CHANNEL_ID", 423293333864054837))
